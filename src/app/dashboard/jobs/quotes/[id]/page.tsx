...
export default async function QuoteDetailPage({ params }: PageProps) {
  ...
  const serialized = {
    ...
    customerContactName: quote.customerContactName ?? null,
    customerContactEmail: quote.customerContactEmail ?? null,
    customerContactPhone: quote.customerContactPhone ?? null,
